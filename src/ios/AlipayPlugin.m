...
- (void) pay:(CDVInvokedUrlCommand*)command
{
    ...
    [[AlipaySDK defaultService] payOrder:orderString fromScheme:@"a" callback:^(NSDictionary *resultDic) {
...
- (void)handleOpenURL:(NSNotification *)notification
{
    ...
    if ([url isKindOfClass:[NSURL class]] && [url.scheme isEqualToString:@"a"])
    {
